 ...
 * <a href="https://github.com/KataAcademy/PP_2_1_4_spring-types-of-wiring">Заготовка ПП-215</a>
 ...
 * AppConfig. Обратите внимание, что данный метод обозначен аннотацией @Bean, что автоматически подтягивает аргументы
 * в метод. В качестве аргумента выступает бин Wood3.
 * 3) Бин Wood3 помечен как компонент, который конструируется через связывание по @Autowired с помощью конструктора.

 * Собрать цепочку до 8-го элемента, использовав все вышеперечисленные методы связывания. После выполнения вы
